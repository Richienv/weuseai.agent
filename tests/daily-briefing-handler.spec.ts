...
test('drift: templates/mocks/calendar/typical-day.json parses to {events: [...]}', () => {
  const parsed = readFixture('agent-packs/workflow-templates/mocks/calendar/typical-day.json') as { events: CalendarEvent[] }
...
test('drift: templates/mocks/calendar/empty.json is {events: []}', () => {
  const parsed = readFixture('agent-packs/workflow-templates/mocks/calendar/empty.json') as { events: CalendarEvent[] }
  assert.deepEqual(parsed, { events: [] })
})

test('drift: templates/mocks/gmail/typical-day.json has 3 important + 5 noise + 2 follow-up', () => {
  const parsed = readFixture('agent-packs/workflow-templates/mocks/gmail/typical-day.json') as { emails: EmailMessage[] }
...
test('drift: templates/mocks/gmail/empty.json is {emails: []}', () => {
  const parsed = readFixture('agent-packs/workflow-templates/mocks/gmail/empty.json') as { emails: EmailMessage[] }
