...
[TECHNICAL BLOCK]
shot on [camera + lens, e.g. 85mm], eye-detect autofocus locked to the near iris,
both eyes within depth of field, facial plane has the highest acutance and microcontrast,
background may fall soft but the eyes and face may not, unretouched, no beauty filter,
no skin smoothing, no flawless skin, no facial diffusion or bloom, fine grain
...
For a face-led portrait, inspect the result at 100 percent before accepting it. The eye plane must be the sharpest region in the frame. Require clearly resolved iris fibers, lashes, brows, hairline strands, lip texture, and natural skin microrelief. Reject missed focus, uniform softness, diffusion across the face, motion blur, or a product/background that is sharper than the subject. Regenerate from the same composition instead of compensating with aggressive sharpening.
