...
## Two failures the model adds silently: skin tone & age

Even with locked identity and great texture, these two drift wrong unless you pin them — and they're the most common "this looks off / that's not me" complaints:

- **Skin tone.** Moody, low-key, or desaturated lighting *under-exposes the complexion* and makes the person look darker, dimmer, and muddier than they really are. **A dark background must never mean dark skin.** Always (1) name the subject's **true complexion** and demand it be **accurately exposed** — e.g. "his real warm light-to-medium skin tone, evenly and brightly exposed, luminous and clear, not darkened/dim/muddy, no crushed shadows on the face, accurate white balance" — and (2) **light the subject** even when the background stays dark (key on the face + fill to lift shadows).
- **Age.** Models drift *older*: hard shadows, heavy macro texture, deep contrast, eye-bags and stubble all add years. **State the exact age**, and for young adults steer explicitly: "24 years old, youthful, smooth healthy skin, no wrinkles, no eye bags, no nasolabial folds, soft contrast, rested." Reserve heavy texture and hard raking light for genuinely older subjects; for the young, soften the key and lift exposure.

Pin **true tone + exact age** on every human, every time.
...
## Richie/WeUseAI face-first campaign lock

Apply this only to Richie/WeUseAI human-led campaign images where the face is the declared focal point.

- **Face sharpness is a hard acceptance gate.** Do not rely on the word “sharp.” Specify eye-detect autofocus locked to the near iris, both eyes inside the depth of field, and the facial plane carrying the highest acutance and microcontrast in the frame. Prefer a 50–85 mm portrait lens around f/4–f/5.6 with adequate shutter speed. Background bokeh is allowed; softness, diffusion, bloom, motion blur, or cinematic haze across the eyes and face is not.
- **Inspect the generated face at 100 percent.** Reject and regenerate if iris fibers, eyelash edges, brow hairs, hairline strands, lip texture, or natural pore-level microrelief are softer than the clothing, product, or background. Do not try to rescue missed focus with generic upscaling or oversharpening.
- **Keep the focal hierarchy explicit.** Face first, product second, environment third. For half-body product portraits, keep the product near the facial focal plane without letting its sharpness exceed the face.
- **Honor a requested one-pass product mark.** When the user wants the mark created in the same generation, provide the approved logo/product reference as a separate input and describe the mark as physically printed, embedded, molded, or screen-printed into the product material. It must follow cylinder curvature and perspective, inherit highlights/refraction/occlusion, and never read as a flat sticker, pasted overlay, floating decal, or later compositing pass.
- **Lock the WeUseAI cat mark from the supplied reference.** Preserve its orange rounded cat-head silhouette, two pointed ears, two black circular eyes, small black nose, and short mouth mark. No letters, alternate mascot, extra facial marks, rectangular backing, outline sticker, or invented near-match.
...
- **Texture lighting** — `raking 45° sidelight, ambient occlusion in facial crevices`. Sidelight reveals skin; AO grounds the form. (But for young/bright looks, soften it and add fill — hard raking light darkens tone and adds age.)
- **Tone & age fidelity** — name the true complexion + exact age; **expose for the face** (dark background ≠ dark skin); soften the key and lift shadows for younger subjects so they don't read older or muddier than they are.
