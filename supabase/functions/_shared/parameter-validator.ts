...
//
// Used by workflow-discover to compute which params the customer still
// needs to provide. Returns the array of `required` property names from
// the top-level object schema, or [] if the schema doesn't have one.
